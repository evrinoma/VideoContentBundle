...
interface VideoContentApiDtoInterface extends IdInterface, VideoInterface, BodyInterface, TitleInterface, PositionInterface, ActiveInterface, PreviewInterface, UrlInterface, StartInterface
{
}
