...
namespace Evrinoma\VideoContentBundle\DependencyInjection\Compiler\Constraint\Property;
...
{
    public const VIDEO_CONTENT_CONSTRAINT = 'evrinoma.video_content.constraint.property';
